...
public struct SwiftCryptoProvider: CryptoProvider {
    ...
    public func sha512(_ message: Data) -> Data {
        Data(SHA512.hash(data: Foundation.Data(Array(message))))
    }
    ...
    public func seal(
        ...
        do {
            ...
            return Data(Array(sealedBox.ciphertext) + Array(sealedBox.tag))
        } catch {
            throw .invalidData
        }
    }
    ...
    public func makeEd25519PrivateKey() -> Data {
        Data(Curve25519.Signing.PrivateKey().rawRepresentation)
    }

    public func ed25519PublicKey(for privateKey: Data) -> Data {
    ...
    public func ed25519Signature(
        ...
        do {
            ...
            return Data(try key.signature(for: Foundation.Data(Array(message))))
        } catch {
            throw .invalidData
        }
    }
    ...
    public func makeCurve25519PrivateKey() -> Data {
        Data(Curve25519.KeyAgreement.PrivateKey().rawRepresentation)
    }

    public func curve25519PublicKey(for privateKey: Data) -> Data {
    ...
    public func curve25519SharedSecret(
        ...
        do {
            ...
            return secret.withUnsafeBytes { Data(Array($0)) }
        } catch {
            throw .invalidData
        }
    }
